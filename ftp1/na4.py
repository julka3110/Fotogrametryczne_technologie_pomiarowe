    ...
    try:
        with open(markers_path) as file:
            for line in file:
                ...
                markers_from_file.append([x,y,z])
    except Exception as e:
        app.messageBox(f"Error during importing markers: {str(e)}")

# image_folder = r'C:\studia\sem5\Fotogrametria\ftp1\P3P'
# output_folder = r'C:\studia\sem5\Fotogrametria\ftp1'
    ...
    try:
        for marker in chunk.markers:
            ...
            for file_marker in markers_from_file:
                x_diff = abs(marker_position[0] - file_marker[0])
                y_diff = abs(marker_position[1] - file_marker[1])
                z_diff = abs(marker_position[2] - file_marker[2])
                
                if x_diff < 0.5 and y_diff < 0.5 and z_diff < 0.5:
                    marker.reference.location = [file_marker[0], file_marker[1], file_marker[2]]
                else:
...
def export_camera_orientations():
    try:
        ...
        output_file = os.path.join(folder_path, "camera_orientations2.txt")
        chunk.exportReference(path=output_file, format=Metashape.ReferenceFormat.ReferenceFormatCSV, items=Metashape.ReferenceItems.ReferenceItemsCameras, columns='nxyzabcUVWDEF',
...
class Ui_Wizard(object):
    def setupUi(self, Wizard):
        ...
        #self.addPhotosButton.clicked.connect(add_photos)
        ...
        # self.allignPhotosButton = QtWidgets.QPushButton(parent=self.alignPhotosgroupBox)
        # self.allignPhotosButton.setGeometry(QtCore.QRect(50, 100, 81, 24))
        # self.allignPhotosButton.setObjectName("allignPhotosButton")
        # self.allignPhotosButton.clicked.connect(lambda: allign_photos(self))
        
        self.crsButton = QtWidgets.QPushButton(parent=Wizard)
        self.crsButton.setGeometry(QtCore.QRect(440, 20, 200, 24))
        self.crsButton.setObjectName("crsButton")
        #self.crsButton.clicked.connect(add_photosCRS)
        ...
        # self.buildCloudButton = QtWidgets.QPushButton(parent=self.cloudGroupBox)
        # self.buildCloudButton.setGeometry(QtCore.QRect(30, 100, 131, 24))
        # self.buildCloudButton.setObjectName("buildCloudButton")
        # self.buildCloudButton.clicked.connect(lambda: build_cloud(self))
        ...
        # self.buildModelButtom = QtWidgets.QPushButton(parent=self.modelGroupBox)
        # self.buildModelButtom.setGeometry(QtCore.QRect(20, 60, 131, 24))
        # self.buildModelButtom.setObjectName("buildModelButtom")
        
        # self.markersGroupBox = QtWidgets.QGroupBox(parent=Wizard)
        # self.markersGroupBox.setGeometry(QtCore.QRect(10, 270, 191, 80))
        # self.markersGroupBox.setObjectName("markersGroupBox")
        
        # self.detectMarkersButton = QtWidgets.QPushButton(parent=self.markersGroupBox)
        # self.detectMarkersButton.setGeometry(QtCore.QRect(10, 20, 161, 24))
        # self.detectMarkersButton.setObjectName("detectMarkersButton")
        # self.detectMarkersButton.clicked.connect(detect_markers)
        
        # self.markersCoordsButton = QtWidgets.QPushButton(parent=self.markersGroupBox)
        # self.markersCoordsButton.setGeometry(QtCore.QRect(10, 50, 171, 24))
        # self.markersCoordsButton.setObjectName("markersCoordsButton")
        # self.markersCoordsButton.clicked.connect(calculate_marker_positions)
        
        # self.pushButton = QtWidgets.QPushButton(parent=Wizard)
        # self.pushButton.setGeometry(QtCore.QRect(10, 370, 181, 24))
        # self.pushButton.setObjectName("pushButton")
        # self.pushButton.clicked.connect(export_camera_orientations)
        ...
        self.doall4Button.setGeometry(QtCore.QRect(260, 260, 131, 24))
    ...
    def retranslateUi(self, Wizard):
        ...
        self.addPhotosButton.setText(_translate("Wizard", "Add Photos"))
        self.addMarkersButton.setText(_translate("Wizard", "Add Markers"))
        ...
        #self.allignPhotosButton.setText(_translate("Wizard", "Align Photos"))
        self.crsButton.setText(_translate("Wizard", "Coordinate System"))
       ...
       # self.buildCloudButton.setText(_translate("Wizard", "Build Point Cloud"))
        ...
        # self.buildModelButtom.setText(_translate("Wizard", "Build Model"))
        # self.markersGroupBox.setTitle(_translate("Wizard", "Markers"))
        # self.detectMarkersButton.setText(_translate("Wizard", "Detect Markers"))
        # self.markersCoordsButton.setText(_translate("Wizard", "Assign Markers Coordinates"))
        # self.pushButton.setText(_translate("Wizard", "Export Camera Orientations"))
        self.pushButton_2.setText(_translate("Wizard", "Do all"))
