...
def import_markers( stripNumber = 0, pairNumber = 0):
    with open(r"C:\studia\sem5\Fotogrametria\ftp1\osnowa_UAV.txt") as file:
        for line in file:
            line = line.split()
...
def select_photos():
    folder = app.getExistingDirectory("Wybierz folder ze zdjeciami")
    global folder_path
    folder_path = folder
...
def build_cloud(ui):
    try:
        ...
        app.messageBox("Cloud built and saved successfully")
    except Exception as e:
...
def build_model(ui):
    ...
    try:
        ...
        app.messageBox("Model built and saved successfully")
    except Exception as e:
...
class Ui_Wizard(object):
    def setupUi(self, Wizard):
        ...
        self.addPhotosButton.setGeometry(QtCore.QRect(20, 20, 261, 24))
        ...
        self.crsButton.setGeometry(QtCore.QRect(340, 20, 251, 24))
